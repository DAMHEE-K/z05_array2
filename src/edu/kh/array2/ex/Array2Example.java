...
public class Array2Example {
	...
	public void ex1() {
		...
		*/
		...
		// Arryas.toString(배열명) : 참조하고 있는 1차원 배열 값을 문자열로 반환
	...
	public void ex3() {
		...
		arr[0] = new char[3]; // 0행에 3열짜리 1차원 배열을 생성하여 주소 값 저장
		arr[1] = new char[4]; // 1행에 4열짜리 1차원 배열을 생성하여 주소 값 저장
		arr[2] = new char[5]; // 2행에 5열짜리 1차원 배열을 생성하여 주소 값 저장
		arr[3] = new char[2]; // 3행에 2열짜리 1차원 배열을 생성하여 주소 값 저장
